...
/**
 * This is the item provider adapter for a {@link ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.xmontiarc.Guard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GuardItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Guard_not_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Guard_not_feature", "_UI_Guard_type"),
				 XmontiarcPackage.Literals.GUARD__NOT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Guard_type") + " " + guard.isNot();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Guard.class)) {
			case XmontiarcPackage.GUARD__NOT:
	...
	public ResourceLocator getResourceLocator() {
		return XMontiArcWithAutomatonEditPlugin.INSTANCE;
	}
