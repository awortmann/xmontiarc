...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ConnectorAspect;
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.SubcomponentAspect;
...
public class ComponentTypeAspect {
  ...
  public static void initializeModel(final ComponentType _self, final EList<String> args) {
    final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspectComponentTypeAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspectComponentTypeAspectContext.getSelf(_self);
  ...
  public static void main(final ComponentType _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspectComponentTypeAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspectComponentTypeAspectContext
			.getSelf(_self);
  ...
  public static Subcomponent findOwnerOf(final ComponentType _self, final Port p) {
	...
	;
	return (ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.xmontiarc.Subcomponent) result;
}
