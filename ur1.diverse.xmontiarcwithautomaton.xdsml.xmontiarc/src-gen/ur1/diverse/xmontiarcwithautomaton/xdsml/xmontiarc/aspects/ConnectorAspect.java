...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect;
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectProperties;
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.PortAspect;
...
public class ConnectorAspect {
  public static void update(final Connector _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectContext
			.getSelf(_self);
  ...
  public static Port getSource(final Connector _self) {
	...
	;
	return (ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.xmontiarc.Port) result;
}
