 ...
 * </p>
 * <ul>
 *   <li>{@link montiarc.impl.ComponentImpl#getInstanceName <em>Instance Name</em>}</li>
 *   <li>{@link montiarc.impl.ComponentImpl#getType <em>Type</em>}</li>
 *   <li>{@link montiarc.impl.ComponentImpl#getPorts <em>Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	protected EClass eStaticClass() {
		return MontiarcPackage.Literals.COMPONENT;
	}
	...
	public void setInstanceName(String newInstanceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MontiarcPackage.COMPONENT__INSTANCE_NAME, oldInstanceName, instanceName));
	}
	...
	public ComponentType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MontiarcPackage.COMPONENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(ComponentType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MontiarcPackage.COMPONENT__TYPE, oldType, type));
	}
	...
	public EList<Port> getPorts() {
		if (ports == null) {
			ports = new EObjectResolvingEList<Port>(Port.class, this, MontiarcPackage.COMPONENT__PORTS);
			...
			for (PortType pt : portTypes) {
				...
				Port p = MontiarcFactory.eINSTANCE.createPort();
				p.setType(pt);
				ports.add(p);
			}
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MontiarcPackage.COMPONENT__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case MontiarcPackage.COMPONENT__PORTS:
				return getPorts();
		}
