 ...
 * </p>
 * <ul>
 *   <li>{@link montiarc.impl.ConnectorTypeImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConnectorTypeImpl extends MinimalEObjectImpl.Container implements ConnectorType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return MontiarcPackage.Literals.CONNECTOR_TYPE;
	}
	...
	public ComponentType getParent() {
		if (eContainerFeatureID() != MontiarcPackage.CONNECTOR_TYPE__PARENT) return null;
	...
	public NotificationChain basicSetParent(ComponentType newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, MontiarcPackage.CONNECTOR_TYPE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(ComponentType newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != MontiarcPackage.CONNECTOR_TYPE__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MontiarcPackage.CONNECTOR_TYPE__PARENT, newParent, newParent));
	}
