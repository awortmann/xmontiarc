...
import org.gemoc.portautomata.fsm.k3dsa.VariableAspectVariableAspectProperties;
...
public class VariableAspectVariableAspectContext {
  ...
  public static VariableAspectVariableAspectProperties getSelf(final Variable _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.gemoc.portautomata.fsm.k3dsa.VariableAspectVariableAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Variable, VariableAspectVariableAspectProperties> map = new java.util.WeakHashMap<org.gemoc.portautomata.fsm.Variable, org.gemoc.portautomata.fsm.k3dsa.VariableAspectVariableAspectProperties>();
