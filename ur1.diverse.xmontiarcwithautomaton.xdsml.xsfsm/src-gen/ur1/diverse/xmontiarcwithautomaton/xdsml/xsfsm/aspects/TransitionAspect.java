...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect;
...
public class TransitionAspect {
  ...
  public static void fire(final Transition _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.TransitionAspectTransitionAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.TransitionAspectTransitionAspectContext
			.getSelf(_self);
