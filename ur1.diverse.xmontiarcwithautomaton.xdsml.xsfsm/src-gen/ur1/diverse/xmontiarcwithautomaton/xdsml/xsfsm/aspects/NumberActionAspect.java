...
public class NumberActionAspect extends ActionAspect {
  ...
  public static void execute(final NumberAction _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.NumberActionAspectNumberActionAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.NumberActionAspectNumberActionAspectContext
			.getSelf(_self);
