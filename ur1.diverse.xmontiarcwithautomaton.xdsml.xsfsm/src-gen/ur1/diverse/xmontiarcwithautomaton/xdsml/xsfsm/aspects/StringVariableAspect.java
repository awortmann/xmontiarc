...
public class StringVariableAspect {
  public static String value(final StringVariable _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StringVariableAspectStringVariableAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StringVariableAspectStringVariableAspectContext
			.getSelf(_self);
	Object result = null;
