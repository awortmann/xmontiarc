...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.TransitionAspect;
...
public class StateAspect {
  ...
  public static void step(final State _self, final String inputString) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateAspectStateAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateAspectStateAspectContext
			.getSelf(_self);
