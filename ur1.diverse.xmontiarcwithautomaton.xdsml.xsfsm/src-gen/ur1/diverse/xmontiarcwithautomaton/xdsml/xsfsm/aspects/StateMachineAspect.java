...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateAspect;
import ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspectStateMachineAspectProperties;
...
public class StateMachineAspect {
  ...
  public static void main(final StateMachine _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspectStateMachineAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspectStateMachineAspectContext
			.getSelf(_self);
  ...
  public static void initializeModel(final StateMachine _self, final EList<String> args) {
    final ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspectStateMachineAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspectStateMachineAspectContext.getSelf(_self);
  ...
  public static State currentState(final StateMachine _self) {
	...
	;
	return (ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.fsm.State) result;
}
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("getCurrentState") &&
    			m.getParameterTypes().length == 0) {
    				...
    				if (ret != null) {
    					return (ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.fsm.State) ret;
    				}
    		}
    	}
    } catch (Exception e) {
