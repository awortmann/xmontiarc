...
public class CdSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CdPackage.CD_ATTRIBUTE: {
				CDAttribute cdAttribute = (CDAttribute)theEObject;
				T result = caseCDAttribute(cdAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CdPackage.CD_ENUMERATION: {
				CDEnumeration cdEnumeration = (CDEnumeration)theEObject;
				T result = caseCDEnumeration(cdEnumeration);
				if (result == null) result = caseCDClass(cdEnumeration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CdPackage.CD_CONSTANT: {
				CDConstant cdConstant = (CDConstant)theEObject;
				T result = caseCDConstant(cdConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CD Attribute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CD Attribute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCDAttribute(CDAttribute object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CD Enumeration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CD Enumeration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCDEnumeration(CDEnumeration object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>CD Constant</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CD Constant</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCDConstant(CDConstant object) {
		return null;
	}
