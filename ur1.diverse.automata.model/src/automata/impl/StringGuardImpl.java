...
public class StringGuardImpl extends GuardImpl implements StringGuard {
	...
	protected EClass eStaticClass() {
		return AutomataPackage.Literals.STRING_GUARD;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.STRING_GUARD__VALUE, oldValue, value));
	}
	...
	public void setOperator(StringOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.STRING_GUARD__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AutomataPackage.STRING_GUARD__VALUE:
				return getValue();
