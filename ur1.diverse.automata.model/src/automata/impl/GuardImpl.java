 ...
 * </p>
 * <ul>
 *   <li>{@link automata.impl.GuardImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardImpl extends MinimalEObjectImpl.Container implements Guard {
	...
	protected EClass eStaticClass() {
		return AutomataPackage.Literals.GUARD;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AutomataPackage.GUARD__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Variable newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.GUARD__SOURCE, oldSource, source));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AutomataPackage.GUARD__SOURCE:
