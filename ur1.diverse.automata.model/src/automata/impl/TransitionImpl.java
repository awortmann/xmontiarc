...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setSource(State newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.TRANSITION__SOURCE, oldSource, source));
	}
	...
	public void setTarget(State newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.TRANSITION__TARGET, oldTarget, target));
	}
	...
	public NotificationChain basicSetGuard(Guard newGuard, NotificationChain msgs) {
		...
		guard = newGuard;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AutomataPackage.TRANSITION__GUARD, oldGuard, newGuard);
	...
	public void setGuard(Guard newGuard) {
		if (newGuard != guard) {
			...
			if (guard != null)
				msgs = ((InternalEObject)guard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AutomataPackage.TRANSITION__GUARD, null, msgs);
			if (newGuard != null)
				msgs = ((InternalEObject)newGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AutomataPackage.TRANSITION__GUARD, null, msgs);
			msgs = basicSetGuard(newGuard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.TRANSITION__GUARD, newGuard, newGuard));
	}
