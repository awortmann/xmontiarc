 ...
 * </p>
 * <ul>
 *   <li>{@link automata.impl.BooleanVariableImpl#isInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanVariableImpl extends VariableImpl implements BooleanVariable {
	...
	protected EClass eStaticClass() {
		return AutomataPackage.Literals.BOOLEAN_VARIABLE;
	}
	...
	public void setInitialValue(boolean newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.BOOLEAN_VARIABLE__INITIAL_VALUE, oldInitialValue, initialValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AutomataPackage.BOOLEAN_VARIABLE__INITIAL_VALUE:
