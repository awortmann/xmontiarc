...
public class PortAspect {
  public static String toString(final Port _self) {
	final org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.PortAspectPortAspectProperties _self_ = org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.PortAspectPortAspectContext
			.getSelf(_self);
	Object result = null;
