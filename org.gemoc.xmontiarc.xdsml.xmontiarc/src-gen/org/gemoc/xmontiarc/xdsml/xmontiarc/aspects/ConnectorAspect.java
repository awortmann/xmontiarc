...
import org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect;
...
public class ConnectorAspect {
  public static void update(final Connector _self) {
	final org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectProperties _self_ = org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectContext
			.getSelf(_self);
  ...
  public static Port getSource(final Connector _self) {
	...
	;
	return (org.gemoc.xmontiarc.xdsml.xmontiarc.montiarc.Port) result;
}
