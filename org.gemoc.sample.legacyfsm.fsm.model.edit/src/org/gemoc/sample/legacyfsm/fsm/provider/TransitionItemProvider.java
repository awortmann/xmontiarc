...
public class TransitionItemProvider extends NamedElementItemProvider {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__GUARD,
				 FsmFactory.eINSTANCE.createBooleanGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__GUARD,
				 FsmFactory.eINSTANCE.createStringGuard()));
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__GUARD,
				 FsmFactory.eINSTANCE.createGreaterOrEqualThanNumberGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__GUARD,
				 FsmFactory.eINSTANCE.createLessOrEqualThanNumberGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__ACTION,
				 FsmFactory.eINSTANCE.createStringAction()));
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.TRANSITION__ACTION,
				 FsmFactory.eINSTANCE.createBooleanAction()));
	}
