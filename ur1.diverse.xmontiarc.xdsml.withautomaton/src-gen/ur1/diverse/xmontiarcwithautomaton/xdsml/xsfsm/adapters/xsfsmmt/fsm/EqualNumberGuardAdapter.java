...
public class EqualNumberGuardAdapter extends EObjectAdapter<EqualNumberGuard> implements ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.EqualNumberGuard {
  ...
  public boolean holds() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.EqualNumberGuardAspect.holds(adaptee);
  }
  ...
  public EClass eClass() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.eINSTANCE.getEqualNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.EQUAL_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.EQUAL_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.EQUAL_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
