...
public class GuardAdapter extends EObjectAdapter<Guard> implements ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.Guard {
  ...
  public boolean holds() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.GuardAspect.holds(adaptee);
  }
  ...
  public EClass eClass() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.eINSTANCE.getGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.GUARD__NOT:
