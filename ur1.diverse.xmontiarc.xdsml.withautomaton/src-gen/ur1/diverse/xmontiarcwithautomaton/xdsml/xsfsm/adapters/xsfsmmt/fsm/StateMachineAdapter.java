...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.Variable;

@SuppressWarnings("all")
public class StateMachineAdapter extends EObjectAdapter<StateMachine> implements ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.StateMachine {
  ...
  public void setInitialState(final State o) {
    if (o != null)
    	adaptee.setInitialState(((ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.adapters.xsfsmmt.fsm.StateAdapter) o).getAdaptee());
  ...
  public void assignInitialValues() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.assignInitialValues(adaptee);
  }
  
  @Override
  public String getConsummedString() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.consummedString(adaptee);
  }
  
  @Override
  public void setConsummedString(final String consummedString) {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.consummedString(adaptee, consummedString
    );
  }
  
  @Override
  public State getCurrentState() {
    return (State) adaptersFactory.createAdapter(ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.currentState(adaptee), eResource);
  }
  
  @Override
  public void setCurrentState(final State currentState) {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.currentState(adaptee, (ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.fsm.State)((EObjectAdapter)currentState).getAdaptee()
    );
  }
  
  @Override
  public void initializeModel(final org.eclipse.emf.common.util.EList<java.lang.String> args) {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.initializeModel(adaptee, args
    );
  }
  
  @Override
  public void main() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.main(adaptee);
  }
  
  @Override
  public String getProducedString() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.producedString(adaptee);
  }
  
  @Override
  public void setProducedString(final String producedString) {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.producedString(adaptee, producedString
    );
  }
  
  @Override
  public String getUnprocessedString() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.unprocessedString(adaptee);
  }
  
  @Override
  public void setUnprocessedString(final String unprocessedString) {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsm.aspects.StateMachineAspect.unprocessedString(adaptee, unprocessedString
    );
  }
  ...
  public EClass eClass() {
    return ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.eINSTANCE.getStateMachine();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__NAME:
    		return getName();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__OWNED_STATES:
    		return getOwnedStates();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__INITIAL_STATE:
    		return getInitialState();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__OWNED_TRANSITIONS:
    		return getOwnedTransitions();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__VARIABLES:
    		return getVariables();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__CURRENT_STATE:
    		return getCurrentState();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__UNPROCESSED_STRING:
    		return getUnprocessedString();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__CONSUMMED_STRING:
    		return getConsummedString();
    	case ur1.diverse.xmontiarcwithautomaton.xdsml.xsfsmmt.fsm.FsmPackage.STATE_MACHINE__PRODUCED_STRING:
