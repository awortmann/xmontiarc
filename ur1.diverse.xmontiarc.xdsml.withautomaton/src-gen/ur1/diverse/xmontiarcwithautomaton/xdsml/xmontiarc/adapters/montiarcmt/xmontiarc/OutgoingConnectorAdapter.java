...
public class OutgoingConnectorAdapter extends EObjectAdapter<OutgoingConnector> implements xmontiarc.OutgoingConnector {
  ...
  public void setSource(final OutgoingPort o) {
    if (o != null)
    	adaptee.setSource(((ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.adapters.montiarcmt.xmontiarc.OutgoingPortAdapter) o).getAdaptee());
  ...
  public void setTarget(final OutgoingPort o) {
    if (o != null)
    	adaptee.setTarget(((ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.adapters.montiarcmt.xmontiarc.OutgoingPortAdapter) o).getAdaptee());
