...
public class ComponentTypeAdapter extends EObjectAdapter<ComponentType> implements ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcmt.xmontiarc.ComponentType {
  ...
  public void setBehavior(final ComponentBehavior o) {
    if (o != null)
    	adaptee.setBehavior(((ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.adapters.xmontiarcmt.xmontiarc.ComponentBehaviorAdapter) o).getAdaptee());
    else adaptee.setBehavior(null);
  }
  
  @Override
  public void compute() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.compute(adaptee);
  }
  
  @Override
  public Subcomponent findOwnerOf(final Port p) {
    return (Subcomponent) adaptersFactory.createAdapter(ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.findOwnerOf(adaptee, (ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.xmontiarc.Port)((EObjectAdapter)p).getAdaptee()
    ), eResource);
  }
  
  @Override
  public EList<Port> getDirectedPortsOfSubcomponents(final boolean collectIncoming) {
    return fr.inria.diverse.melange.adapters.EListAdapter.newInstance(ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.getDirectedPortsOfSubcomponents(adaptee, collectIncoming
    ), adaptersFactory, eResource);
  }
  
  @Override
  public EList<Port> getIncomingPortsOfSubcomponents() {
    return fr.inria.diverse.melange.adapters.EListAdapter.newInstance(ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.getIncomingPortsOfSubcomponents(adaptee), adaptersFactory, eResource);
  }
  
  @Override
  public EList<Port> getOutgoingPortsOfSubcomponents() {
    return fr.inria.diverse.melange.adapters.EListAdapter.newInstance(ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.getOutgoingPortsOfSubcomponents(adaptee), adaptersFactory, eResource);
  }
  
  @Override
  public void initializeModel(final org.eclipse.emf.common.util.EList<java.lang.String> args) {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.initializeModel(adaptee, args
    );
  }
  
  @Override
  public void main() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.main(adaptee);
  }
  
  @Override
  public void update() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.ComponentTypeAspect.update(adaptee);
  }
