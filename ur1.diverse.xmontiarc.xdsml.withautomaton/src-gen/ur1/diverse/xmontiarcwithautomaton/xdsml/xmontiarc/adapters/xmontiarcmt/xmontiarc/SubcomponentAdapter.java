...
public class SubcomponentAdapter extends EObjectAdapter<Subcomponent> implements ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcmt.xmontiarc.Subcomponent {
  ...
  public void setType(final ComponentType o) {
    if (o != null)
    	adaptee.setType(((ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.adapters.xmontiarcmt.xmontiarc.ComponentTypeAdapter) o).getAdaptee());
  ...
  @Override
  public void compute() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.SubcomponentAspect.compute(adaptee);
  }
  
  @Override
  public void createDefaultBehavior() {
    ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarc.aspects.SubcomponentAspect.createDefaultBehavior(adaptee);
  }
