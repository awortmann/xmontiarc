...
public class ComponentTypeAdapter extends EObjectAdapter<ComponentType> implements xmontiarc.ComponentType {
  ...
  public void setBehavior(final ComponentBehavior o) {
    if (o != null)
    	adaptee.setBehavior(((ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.adapters.montiarcmt.xmontiarc.ComponentBehaviorAdapter) o).getAdaptee());
