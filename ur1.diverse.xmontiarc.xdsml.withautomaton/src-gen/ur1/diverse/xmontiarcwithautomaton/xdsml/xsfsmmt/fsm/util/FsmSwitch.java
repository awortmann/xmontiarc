...
public class FsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FsmPackage.STRING_VARIABLE: {
			...
			case FsmPackage.BOOLEAN_VARIABLE: {
			...
			case FsmPackage.BOOLEAN_ACTION: {
			...
			case FsmPackage.GREATER_OR_EQUAL_THAN_NUMBER_GUARD: {
			...
			case FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD: {
