...
public class BooleanActionAspect extends ActionAspect {
  ...
  public static void execute(final BooleanAction _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.BooleanActionAspectBooleanActionAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.BooleanActionAspectBooleanActionAspectContext
			.getSelf(_self);
