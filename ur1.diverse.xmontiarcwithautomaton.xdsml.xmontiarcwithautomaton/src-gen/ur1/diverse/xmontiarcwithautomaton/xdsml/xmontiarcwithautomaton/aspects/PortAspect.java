...
public class PortAspect {
  public static String toString(final Port _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.PortAspectPortAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.PortAspectPortAspectContext
			.getSelf(_self);
	Object result = null;
