...
public class NumberVariableAspect {
  public static Long value(final NumberVariable _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.NumberVariableAspectNumberVariableAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.NumberVariableAspectNumberVariableAspectContext
			.getSelf(_self);
	Object result = null;
