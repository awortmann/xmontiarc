...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.StateMachineAspect;
...
public class TransitionAspect {
  ...
  public static void fire(final Transition _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.TransitionAspectTransitionAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.TransitionAspectTransitionAspectContext
			.getSelf(_self);
  ...
  protected static void _privk3_fire(final TransitionAspectTransitionAspectProperties _self_, final Transition _self) {
    ...
    final AutomatonComponentBehavior fsm = _source.getOwningFSM();
