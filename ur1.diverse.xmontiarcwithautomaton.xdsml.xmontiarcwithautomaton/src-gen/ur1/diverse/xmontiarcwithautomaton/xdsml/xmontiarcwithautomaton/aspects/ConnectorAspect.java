...
import ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.ComponentTypeAspect;
...
public class ConnectorAspect {
  public static void update(final Connector _self) {
	final ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.ConnectorAspectConnectorAspectProperties _self_ = ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.aspects.ConnectorAspectConnectorAspectContext
			.getSelf(_self);
  ...
  public static Port getSource(final Connector _self) {
	...
	;
	return (ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.xmontiarc.Port) result;
}
