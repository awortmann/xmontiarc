 ...
 * </p>
 * <ul>
 *   <li>{@link ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.xmontiarc.impl.BooleanActionImpl#isValue <em>Value</em>}</li>
 *   <li>{@link ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.xmontiarc.impl.BooleanActionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanActionImpl extends ActionImpl implements BooleanAction {
	...
	protected EClass eStaticClass() {
		return XmontiarcPackage.Literals.BOOLEAN_ACTION;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmontiarcPackage.BOOLEAN_ACTION__VALUE, oldValue, value));
	}
	...
	public BooleanVariable getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XmontiarcPackage.BOOLEAN_ACTION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(BooleanVariable newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmontiarcPackage.BOOLEAN_ACTION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmontiarcPackage.BOOLEAN_ACTION__VALUE:
				return isValue();
			case XmontiarcPackage.BOOLEAN_ACTION__TARGET:
