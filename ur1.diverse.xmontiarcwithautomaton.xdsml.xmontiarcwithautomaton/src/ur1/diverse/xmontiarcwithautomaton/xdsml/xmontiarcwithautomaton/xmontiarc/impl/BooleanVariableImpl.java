 ...
 * </p>
 * <ul>
 *   <li>{@link ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.xmontiarc.impl.BooleanVariableImpl#isInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link ur1.diverse.xmontiarcwithautomaton.xdsml.xmontiarcwithautomaton.xmontiarc.impl.BooleanVariableImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanVariableImpl extends VariableImpl implements BooleanVariable {
	...
	protected EClass eStaticClass() {
		return XmontiarcPackage.Literals.BOOLEAN_VARIABLE;
	}
	...
	public void setInitialValue(boolean newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmontiarcPackage.BOOLEAN_VARIABLE__INITIAL_VALUE, oldInitialValue, initialValue));
	}
	...
	public void setValue(Boolean newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmontiarcPackage.BOOLEAN_VARIABLE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmontiarcPackage.BOOLEAN_VARIABLE__INITIAL_VALUE:
				return isInitialValue();
			case XmontiarcPackage.BOOLEAN_VARIABLE__VALUE:
				return getValue();
		}
