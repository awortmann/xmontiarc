...
public class GreaterThanNumberGuardAdapter extends EObjectAdapter<GreaterThanNumberGuard> implements org.gemoc.sample.legacyfsm.fsm.GreaterThanNumberGuard {
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacyfsm.fsm.FsmPackage.eINSTANCE.getGreaterThanNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.GREATER_THAN_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.GREATER_THAN_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.GREATER_THAN_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
