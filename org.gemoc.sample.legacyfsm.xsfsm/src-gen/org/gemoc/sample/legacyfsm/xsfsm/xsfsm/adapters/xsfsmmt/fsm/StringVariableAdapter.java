...
public class StringVariableAdapter extends EObjectAdapter<StringVariable> implements org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.StringVariable {
  ...
  public String getValue() {
    return org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.StringVariableAspect.value(adaptee);
  }
  
  @Override
  public void setValue(final String value) {
    org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.StringVariableAspect.value(adaptee, value
    );
  }
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.eINSTANCE.getStringVariable();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.STRING_VARIABLE__NAME:
    		return getName();
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.STRING_VARIABLE__INITIAL_VALUE:
    		return getInitialValue();
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.STRING_VARIABLE__VALUE:
    		return getValue();
    }
