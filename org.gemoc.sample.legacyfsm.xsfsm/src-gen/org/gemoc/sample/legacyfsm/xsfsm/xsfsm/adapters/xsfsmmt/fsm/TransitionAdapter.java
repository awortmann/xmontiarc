...
public class TransitionAdapter extends EObjectAdapter<Transition> implements org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.Transition {
  ...
  public void setGuard(final Guard o) {
    if (o != null)
    	adaptee.setGuard(((org.gemoc.sample.legacyfsm.xsfsm.xsfsm.adapters.xsfsmmt.fsm.GuardAdapter) o).getAdaptee());
  ...
  public void setAction(final Action o) {
    if (o != null)
    	adaptee.setAction(((org.gemoc.sample.legacyfsm.xsfsm.xsfsm.adapters.xsfsmmt.fsm.ActionAdapter) o).getAdaptee());
  ...
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	...
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__OUTPUT:
    		return getOutput();
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__GUARD:
    		return getGuard();
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__ACTION:
    		setAction(
    		(org.gemoc.sample.legacyfsm.xsfsm.xsfsmmt.fsm.Action)
    		 newValue);
    		return;
    }
