...
public class SubcomponentAdapter extends EObjectAdapter<Subcomponent> implements org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.Subcomponent {
  ...
  public void setType(final ComponentType o) {
    if (o != null)
    	adaptee.setType(((org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.adapters.xmontiarcfsmmt.montiarc.ComponentTypeAdapter) o).getAdaptee());
  ...
  @Override
  public void compute() {
    org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.aspects.SubcomponentAspect.compute(adaptee);
  }
  
  @Override
  public void createDefaultBehavior() {
    org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.aspects.SubcomponentAspect.createDefaultBehavior(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.eINSTANCE.getSubcomponent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.SUBCOMPONENT__NAME:
    		return getName();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.SUBCOMPONENT__TYPE:
    		return getType();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.SUBCOMPONENT__INCOMING_PORTS:
    		return getIncomingPorts();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.SUBCOMPONENT__PARENT:
    		return getParent();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.SUBCOMPONENT__OUTGOING_PORTS:
