...
public class IntermediateConnectorAdapter extends EObjectAdapter<IntermediateConnector> implements org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.IntermediateConnector {
  ...
  public void setSource(final OutgoingPort o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.adapters.xmontiarcfsmmt.montiarc.OutgoingPortAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.eINSTANCE.getIntermediateConnector();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__PARENT:
    		return getParent();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__SOURCE:
    		return getSource();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__TARGET:
    		return getTarget();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__SOURCE:
    		setSource(
    		(org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.OutgoingPort)
    		 newValue);
    		return;
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__TARGET:
    		setTarget(
