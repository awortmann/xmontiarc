...
public class IncomingPortAdapter extends EObjectAdapter<IncomingPort> implements org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.IncomingPort {
  ...
  public EClass eClass() {
    return org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.eINSTANCE.getIncomingPort();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INCOMING_PORT__TYPE:
    		return getType();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INCOMING_PORT__NAME:
    		return getName();
    	case org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsmmt.montiarc.MontiarcPackage.INCOMING_PORT__VALUE:
    		return getValue();
    }
