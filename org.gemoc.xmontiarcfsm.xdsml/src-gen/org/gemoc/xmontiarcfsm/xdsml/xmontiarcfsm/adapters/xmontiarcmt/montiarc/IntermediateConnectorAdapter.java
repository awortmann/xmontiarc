...
public class IntermediateConnectorAdapter extends EObjectAdapter<IntermediateConnector> implements org.gemoc.xmontiarc.xdsml.xmontiarcmt.montiarc.IntermediateConnector {
  ...
  public void setSource(final OutgoingPort o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.adapters.xmontiarcmt.montiarc.OutgoingPortAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.xmontiarc.xdsml.xmontiarcmt.montiarc.MontiarcPackage.eINSTANCE.getIntermediateConnector();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xmontiarc.xdsml.xmontiarcmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__PARENT:
    		return getParent();
    	case org.gemoc.xmontiarc.xdsml.xmontiarcmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__SOURCE:
    		return getSource();
    	case org.gemoc.xmontiarc.xdsml.xmontiarcmt.montiarc.MontiarcPackage.INTERMEDIATE_CONNECTOR__TARGET:
    		return getTarget();
    }
