...
public class StatesFactoryImpl extends EFactoryImpl implements StatesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case StatesPackage.PORT_PORT_VALUE_VALUE: return createPort_portValue_Value();
	 ...
	 * @generated
	 */
	public Port_portValue_Value createPort_portValue_Value() {
		Port_portValue_ValueImpl port_portValue_Value = new Port_portValue_ValueImpl();
		return port_portValue_Value;
	}
