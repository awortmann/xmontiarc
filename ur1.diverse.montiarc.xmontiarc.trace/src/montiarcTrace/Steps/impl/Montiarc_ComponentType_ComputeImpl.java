...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Montiarc Component Type Compute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link montiarcTrace.Steps.impl.Montiarc_ComponentType_ComputeImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link montiarcTrace.Steps.impl.Montiarc_ComponentType_ComputeImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link montiarcTrace.Steps.impl.Montiarc_ComponentType_ComputeImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Montiarc_ComponentType_ComputeImpl extends StepImpl implements Montiarc_ComponentType_Compute {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Montiarc_ComponentType_Compute_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Montiarc_ComponentType_ComputeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.MONTIARC_COMPONENT_TYPE_COMPUTE;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Montiarc_ComponentType_Compute_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Montiarc_ComponentType_Compute_AbstractSubStep>(Montiarc_ComponentType_Compute_AbstractSubStep.class, this, StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public ComponentType getCaller() {
		return (ur1.diverse.montiarc.xdsml.xmontiarc.montiarc.ComponentType) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Montiarc_ComponentType_Compute_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
		...
		if (baseClass == Montiarc_ComponentType_Compute_AbstractSubStep.class) {
			switch (derivedFeatureID) {
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.MONTIARC_COMPONENT_TYPE_COMPUTE__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
...
} //Montiarc_ComponentType_ComputeImpl
