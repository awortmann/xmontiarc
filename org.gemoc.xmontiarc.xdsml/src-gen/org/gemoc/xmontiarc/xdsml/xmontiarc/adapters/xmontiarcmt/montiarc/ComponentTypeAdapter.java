...
public class ComponentTypeAdapter extends EObjectAdapter<ComponentType> implements org.gemoc.xmontiarc.xdsml.xmontiarcmt.montiarc.ComponentType {
  ...
  public void setBehavior(final ComponentBehavior o) {
    if (o != null)
    	adaptee.setBehavior(((org.gemoc.xmontiarc.xdsml.xmontiarc.adapters.xmontiarcmt.montiarc.ComponentBehaviorAdapter) o).getAdaptee());
    else adaptee.setBehavior(null);
  }
  
  @Override
  public void compute() {
    org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.compute(adaptee);
  }
  
  @Override
  public Subcomponent findOwnerOf(final Port p) {
    return (Subcomponent) adaptersFactory.createAdapter(org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.findOwnerOf(adaptee, (org.gemoc.xmontiarc.xdsml.xmontiarc.montiarc.Port)((EObjectAdapter)p).getAdaptee()
    ), eResource);
  }
  
  @Override
  public EList<Port> getDirectedPortsOfSubcomponents(final boolean collectIncoming) {
    return fr.inria.diverse.melange.adapters.EListAdapter.newInstance(org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.getDirectedPortsOfSubcomponents(adaptee, collectIncoming
    ), adaptersFactory, eResource);
  }
  
  @Override
  public EList<Port> getIncomingPortsOfSubcomponents() {
    return fr.inria.diverse.melange.adapters.EListAdapter.newInstance(org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.getIncomingPortsOfSubcomponents(adaptee), adaptersFactory, eResource);
  }
  
  @Override
  public EList<Port> getOutgoingPortsOfSubcomponents() {
    return fr.inria.diverse.melange.adapters.EListAdapter.newInstance(org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.getOutgoingPortsOfSubcomponents(adaptee), adaptersFactory, eResource);
  }
  
  @Override
  public void initializeModel(final org.eclipse.emf.common.util.EList<java.lang.String> args) {
    org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.initializeModel(adaptee, args
    );
  }
  
  @Override
  public void main() {
    org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.main(adaptee);
  }
  
  @Override
  public void update() {
    org.gemoc.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect.update(adaptee);
  }
