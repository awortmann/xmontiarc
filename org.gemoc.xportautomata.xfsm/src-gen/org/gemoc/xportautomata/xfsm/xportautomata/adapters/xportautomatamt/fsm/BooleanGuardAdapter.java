...
public class BooleanGuardAdapter extends EObjectAdapter<BooleanGuard> implements org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.BooleanGuard {
  ...
  public void setSource(final BooleanVariable o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.xportautomata.xfsm.xportautomata.adapters.xportautomatamt.fsm.BooleanVariableAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.eINSTANCE.getBooleanGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.BOOLEAN_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.BOOLEAN_GUARD__VALUE:
    		return isValue() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.BOOLEAN_GUARD__SOURCE:
    		return getSource();
    }
