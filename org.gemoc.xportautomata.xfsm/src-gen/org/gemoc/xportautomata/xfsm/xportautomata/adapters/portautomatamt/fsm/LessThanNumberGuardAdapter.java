...
public class LessThanNumberGuardAdapter extends EObjectAdapter<LessThanNumberGuard> implements org.gemoc.portautomata.fsm.LessThanNumberGuard {
  ...
  public EClass eClass() {
    return org.gemoc.portautomata.fsm.fsmPackage.eINSTANCE.getLessThanNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.portautomata.fsm.fsmPackage.LESS_THAN_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.portautomata.fsm.fsmPackage.LESS_THAN_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.portautomata.fsm.fsmPackage.LESS_THAN_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
