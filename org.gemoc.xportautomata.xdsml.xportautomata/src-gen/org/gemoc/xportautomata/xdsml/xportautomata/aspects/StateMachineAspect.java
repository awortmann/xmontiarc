...
import org.gemoc.xportautomata.xdsml.xportautomata.aspects.StateMachineAspectStateMachineAspectProperties;
import org.gemoc.xportautomata.xdsml.xportautomata.aspects.StringVariableAspect;
import org.gemoc.xportautomata.xdsml.xportautomata.aspects.TransitionAspect;
...
public class StateMachineAspect {
  ...
  public static void main(final StateMachine _self) {
	final org.gemoc.xportautomata.xdsml.xportautomata.aspects.StateMachineAspectStateMachineAspectProperties _self_ = org.gemoc.xportautomata.xdsml.xportautomata.aspects.StateMachineAspectStateMachineAspectContext
			.getSelf(_self);
  ...
  public static State currentState(final StateMachine _self) {
	...
	;
	return (org.gemoc.xportautomata.xdsml.xportautomata.fsm.State) result;
}
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("getCurrentState") &&
    			m.getParameterTypes().length == 0) {
    				...
    				if (ret != null) {
    					return (org.gemoc.xportautomata.xdsml.xportautomata.fsm.State) ret;
    				}
    		}
    	}
    } catch (Exception e) {
