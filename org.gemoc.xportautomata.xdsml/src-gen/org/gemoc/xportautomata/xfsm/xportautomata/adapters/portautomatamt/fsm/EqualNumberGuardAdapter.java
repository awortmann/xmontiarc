...
public class EqualNumberGuardAdapter extends EObjectAdapter<EqualNumberGuard> implements org.gemoc.portautomata.fsm.EqualNumberGuard {
  ...
  public EClass eClass() {
    return org.gemoc.portautomata.fsm.fsmPackage.eINSTANCE.getEqualNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.portautomata.fsm.fsmPackage.EQUAL_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.portautomata.fsm.fsmPackage.EQUAL_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.portautomata.fsm.fsmPackage.EQUAL_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
