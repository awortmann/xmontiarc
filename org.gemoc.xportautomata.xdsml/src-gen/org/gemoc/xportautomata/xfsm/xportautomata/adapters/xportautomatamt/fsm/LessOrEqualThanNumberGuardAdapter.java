...
public class LessOrEqualThanNumberGuardAdapter extends EObjectAdapter<LessOrEqualThanNumberGuard> implements org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.LessOrEqualThanNumberGuard {
  ...
  public void setSource(final NumberVariable o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.xportautomata.xfsm.xportautomata.adapters.xportautomatamt.fsm.NumberVariableAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.eINSTANCE.getLessOrEqualThanNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
