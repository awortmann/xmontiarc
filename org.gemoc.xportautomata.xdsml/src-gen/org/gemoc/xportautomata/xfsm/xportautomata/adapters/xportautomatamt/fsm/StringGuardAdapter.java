...
public class StringGuardAdapter extends EObjectAdapter<StringGuard> implements org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.StringGuard {
  ...
  public void setSource(final StringVariable o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.xportautomata.xfsm.xportautomata.adapters.xportautomatamt.fsm.StringVariableAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.eINSTANCE.getStringGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.STRING_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.STRING_GUARD__VALUE:
    		return getValue();
    	case org.gemoc.xportautomata.xfsm.xportautomatamt.fsm.FsmPackage.STRING_GUARD__SOURCE:
    		return getSource();
    }
