...
public class StateAdapter extends EObjectAdapter<State> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.State {
  ...
  public void setOwningFSM(final StateMachine o) {
    if (o != null)
    	adaptee.setOwningFSM(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.xportautomatamt.fsm.StateMachineAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STATE__NAME:
    		return getName();
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STATE__OWNING_FSM:
    		return getOwningFSM();
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STATE__OUTGOING_TRANSITIONS:
    		return getOutgoingTransitions();
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STATE__INCOMING_TRANSITIONS:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STATE__OWNING_FSM:
    		setOwningFSM(
    		(org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.StateMachine)
    		 newValue);
    		return;
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STATE__OUTGOING_TRANSITIONS:
