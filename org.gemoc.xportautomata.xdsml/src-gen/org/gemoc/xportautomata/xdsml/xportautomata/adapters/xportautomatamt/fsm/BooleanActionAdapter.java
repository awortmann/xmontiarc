...
public class BooleanActionAdapter extends EObjectAdapter<BooleanAction> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.BooleanAction {
  ...
  public void setTarget(final BooleanVariable o) {
    if (o != null)
    	adaptee.setTarget(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.xportautomatamt.fsm.BooleanVariableAdapter) o).getAdaptee());
    else adaptee.setTarget(null);
  }
  
  @Override
  public void execute() {
    org.gemoc.xportautomata.xdsml.xportautomata.aspects.BooleanActionAspect.execute(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getBooleanAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.BOOLEAN_ACTION__VALUE:
    		return isValue() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.BOOLEAN_ACTION__TARGET:
    		return getTarget();
    }
