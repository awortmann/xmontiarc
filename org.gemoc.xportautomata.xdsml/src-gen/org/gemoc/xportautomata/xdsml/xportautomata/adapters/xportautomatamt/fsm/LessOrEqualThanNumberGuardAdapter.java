...
public class LessOrEqualThanNumberGuardAdapter extends EObjectAdapter<LessOrEqualThanNumberGuard> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.LessOrEqualThanNumberGuard {
  ...
  public boolean holds() {
    return org.gemoc.xportautomata.xdsml.xportautomata.aspects.LessOrEqualThanNumberGuardAspect.holds(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getLessOrEqualThanNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
