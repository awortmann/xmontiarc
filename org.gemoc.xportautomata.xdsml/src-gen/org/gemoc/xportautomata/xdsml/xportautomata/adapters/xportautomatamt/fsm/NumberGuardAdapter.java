...
public class NumberGuardAdapter extends EObjectAdapter<NumberGuard> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.NumberGuard {
  ...
  public boolean holds() {
    return org.gemoc.xportautomata.xdsml.xportautomata.aspects.NumberGuardAspect.holds(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.NUMBER_GUARD__SOURCE:
    		return getSource();
    }
