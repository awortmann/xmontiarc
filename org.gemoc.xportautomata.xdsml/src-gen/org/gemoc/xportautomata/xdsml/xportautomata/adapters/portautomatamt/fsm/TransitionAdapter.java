...
public class TransitionAdapter extends EObjectAdapter<Transition> implements org.gemoc.portautomata.fsm.Transition {
  ...
  public void setSource(final State o) {
    if (o != null)
    	adaptee.setSource(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.portautomatamt.fsm.StateAdapter) o).getAdaptee());
  ...
  public void setTarget(final State o) {
    if (o != null)
    	adaptee.setTarget(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.portautomatamt.fsm.StateAdapter) o).getAdaptee());
  ...
  public void setGuard(final Guard o) {
    if (o != null)
    	adaptee.setGuard(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.portautomatamt.fsm.GuardAdapter) o).getAdaptee());
  ...
  public void setAction(final Action o) {
    if (o != null)
    	adaptee.setAction(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.portautomatamt.fsm.ActionAdapter) o).getAdaptee());
