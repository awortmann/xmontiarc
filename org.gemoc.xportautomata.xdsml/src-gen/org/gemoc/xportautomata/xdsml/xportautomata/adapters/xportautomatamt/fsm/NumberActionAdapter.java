...
public class NumberActionAdapter extends EObjectAdapter<NumberAction> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.NumberAction {
  ...
  public void setTarget(final NumberVariable o) {
    if (o != null)
    	adaptee.setTarget(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.xportautomatamt.fsm.NumberVariableAdapter) o).getAdaptee());
    else adaptee.setTarget(null);
  }
  
  @Override
  public void execute() {
    org.gemoc.xportautomata.xdsml.xportautomata.aspects.NumberActionAspect.execute(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getNumberAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.NUMBER_ACTION__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.NUMBER_ACTION__TARGET:
    		return getTarget();
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.NUMBER_ACTION__EXPRESSION:
