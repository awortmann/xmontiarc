...
public class LessThanNumberGuardAdapter extends EObjectAdapter<LessThanNumberGuard> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.LessThanNumberGuard {
  ...
  public boolean holds() {
    return org.gemoc.xportautomata.xdsml.xportautomata.aspects.LessThanNumberGuardAspect.holds(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getLessThanNumberGuard();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.LESS_THAN_NUMBER_GUARD__NOT:
    		return isNot() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.LESS_THAN_NUMBER_GUARD__VALUE:
    		return new java.lang.Long(getValue());
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.LESS_THAN_NUMBER_GUARD__SOURCE:
    		return getSource();
    }
