...
public class StringActionAdapter extends EObjectAdapter<StringAction> implements org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.StringAction {
  ...
  public void setTarget(final StringVariable o) {
    if (o != null)
    	adaptee.setTarget(((org.gemoc.xportautomata.xdsml.xportautomata.adapters.xportautomatamt.fsm.StringVariableAdapter) o).getAdaptee());
    else adaptee.setTarget(null);
  }
  
  @Override
  public void execute() {
    org.gemoc.xportautomata.xdsml.xportautomata.aspects.StringActionAspect.execute(adaptee);
  }
  ...
  public EClass eClass() {
    return org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.eINSTANCE.getStringAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STRING_ACTION__VALUE:
    		return getValue();
    	case org.gemoc.xportautomata.xdsml.xportautomatamt.fsm.FsmPackage.STRING_ACTION__TARGET:
    		return getTarget();
    }
