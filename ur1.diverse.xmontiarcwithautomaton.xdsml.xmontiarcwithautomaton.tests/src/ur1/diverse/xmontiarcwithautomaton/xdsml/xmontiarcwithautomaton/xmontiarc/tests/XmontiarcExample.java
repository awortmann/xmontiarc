...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>xmontiarc</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class XmontiarcExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(XmontiarcPackage.eNS_URI, 
			 XmontiarcPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.xmontiarcwithautomaton"));
				ComponentType root = XmontiarcFactory.eINSTANCE.createComponentType();
