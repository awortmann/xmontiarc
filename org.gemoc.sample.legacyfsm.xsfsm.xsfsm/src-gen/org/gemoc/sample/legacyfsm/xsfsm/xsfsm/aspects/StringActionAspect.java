...
public class StringActionAspect extends ActionAspect {
  ...
  public static void execute(final StringAction _self) {
	final org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.StringActionAspectStringActionAspectProperties _self_ = org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.StringActionAspectStringActionAspectContext
			.getSelf(_self);
