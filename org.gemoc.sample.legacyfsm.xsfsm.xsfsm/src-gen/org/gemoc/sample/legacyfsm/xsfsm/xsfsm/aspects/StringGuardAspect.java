...
public class StringGuardAspect extends GuardAspect {
  public static boolean holds(final StringGuard _self) {
	final org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.StringGuardAspectStringGuardAspectProperties _self_ = org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.StringGuardAspectStringGuardAspectContext
			.getSelf(_self);
	Object result = null;
