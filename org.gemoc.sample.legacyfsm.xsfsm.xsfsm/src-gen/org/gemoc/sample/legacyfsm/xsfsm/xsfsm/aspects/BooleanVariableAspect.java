...
public class BooleanVariableAspect {
  public static Boolean value(final BooleanVariable _self) {
	final org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.BooleanVariableAspectBooleanVariableAspectProperties _self_ = org.gemoc.sample.legacyfsm.xsfsm.xsfsm.aspects.BooleanVariableAspectBooleanVariableAspectContext
			.getSelf(_self);
	Object result = null;
