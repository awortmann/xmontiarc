 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.xmontiarc.impl.BooleanGuardImpl#isValue <em>Value</em>}</li>
 *   <li>{@link org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.xmontiarc.impl.BooleanGuardImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanGuardImpl extends GuardImpl implements BooleanGuard {
	...
	protected EClass eStaticClass() {
		return XmontiarcPackage.Literals.BOOLEAN_GUARD;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmontiarcPackage.BOOLEAN_GUARD__VALUE, oldValue, value));
	}
	...
	public BooleanVariable getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XmontiarcPackage.BOOLEAN_GUARD__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(BooleanVariable newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmontiarcPackage.BOOLEAN_GUARD__SOURCE, oldSource, source));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmontiarcPackage.BOOLEAN_GUARD__VALUE:
				return isValue();
			case XmontiarcPackage.BOOLEAN_GUARD__SOURCE:
