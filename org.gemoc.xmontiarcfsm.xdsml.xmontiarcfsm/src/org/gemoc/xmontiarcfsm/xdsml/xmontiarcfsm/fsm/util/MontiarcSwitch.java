 ...
 * @generated
 */
public class MontiarcSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MontiarcPackage.TRANSITION: {
			...
			case MontiarcPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MontiarcPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MontiarcPackage.STRING_VARIABLE: {
			...
			case MontiarcPackage.NUMBER_VARIABLE: {
			...
			case MontiarcPackage.BOOLEAN_VARIABLE: {
			...
			case MontiarcPackage.GUARD: {
				Guard guard = (Guard)theEObject;
				T result = caseGuard(guard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MontiarcPackage.BOOLEAN_GUARD: {
			...
			case MontiarcPackage.STRING_GUARD: {
			...
			case MontiarcPackage.NUMBER_GUARD: {
			...
			case MontiarcPackage.EQUAL_NUMBER_GUARD: {
			...
			case MontiarcPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MontiarcPackage.STRING_ACTION: {
			...
			case MontiarcPackage.NUMBER_ACTION: {
			...
			case MontiarcPackage.BOOLEAN_ACTION: {
			...
			case MontiarcPackage.LESS_THAN_NUMBER_GUARD: {
			...
			case MontiarcPackage.GREATER_THAN_NUMBER_GUARD: {
			...
			case MontiarcPackage.GREATER_OR_EQUAL_THAN_NUMBER_GUARD: {
			...
			case MontiarcPackage.LESS_OR_EQUAL_THAN_NUMBER_GUARD: {
