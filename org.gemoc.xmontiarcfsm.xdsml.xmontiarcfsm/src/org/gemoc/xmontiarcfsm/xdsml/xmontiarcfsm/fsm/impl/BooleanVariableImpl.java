 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.fsm.impl.BooleanVariableImpl#isInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.fsm.impl.BooleanVariableImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanVariableImpl extends VariableImpl implements BooleanVariable {
	...
	protected EClass eStaticClass() {
		return MontiarcPackage.Literals.BOOLEAN_VARIABLE;
	}
	...
	public void setInitialValue(boolean newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MontiarcPackage.BOOLEAN_VARIABLE__INITIAL_VALUE, oldInitialValue, initialValue));
	}
	...
	public void setValue(Boolean newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MontiarcPackage.BOOLEAN_VARIABLE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MontiarcPackage.BOOLEAN_VARIABLE__INITIAL_VALUE:
				return isInitialValue();
			case MontiarcPackage.BOOLEAN_VARIABLE__VALUE:
				return getValue();
		}
