...
public class FsmValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "org.gemoc.xmontiarcfsm.xdsml.xmontiarcfsm.montiarc";
	...
	public boolean validateComponentType_AtomicOrComposed(ComponentType componentType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(FsmPackage.Literals.COMPONENT_TYPE,
				 componentType,
				 diagnostics,
				 context,
	...
	public boolean validateSubcomponent_NameIsLowerCase(Subcomponent subcomponent, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(FsmPackage.Literals.SUBCOMPONENT,
				 subcomponent,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
