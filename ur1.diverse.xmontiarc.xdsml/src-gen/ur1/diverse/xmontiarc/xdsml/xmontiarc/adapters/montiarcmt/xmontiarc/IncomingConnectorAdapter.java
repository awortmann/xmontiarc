...
public class IncomingConnectorAdapter extends EObjectAdapter<IncomingConnector> implements xmontiarc.IncomingConnector {
  ...
  public void setSource(final IncomingPort o) {
    if (o != null)
    	adaptee.setSource(((ur1.diverse.xmontiarc.xdsml.xmontiarc.adapters.montiarcmt.xmontiarc.IncomingPortAdapter) o).getAdaptee());
  ...
  public void setTarget(final IncomingPort o) {
    if (o != null)
    	adaptee.setTarget(((ur1.diverse.xmontiarc.xdsml.xmontiarc.adapters.montiarcmt.xmontiarc.IncomingPortAdapter) o).getAdaptee());
