...
public class IncomingConnectorAdapter extends EObjectAdapter<IncomingConnector> implements ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.IncomingConnector {
  ...
  public void setSource(final IncomingPort o) {
    if (o != null)
    	adaptee.setSource(((ur1.diverse.xmontiarc.xdsml.xmontiarc.adapters.xmontiarcmt.xmontiarc.IncomingPortAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.eINSTANCE.getIncomingConnector();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INCOMING_CONNECTOR__PARENT:
    		return getParent();
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INCOMING_CONNECTOR__SOURCE:
    		return getSource();
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INCOMING_CONNECTOR__TARGET:
    		return getTarget();
    }
