...
public class ConnectorAdapter extends EObjectAdapter<Connector> implements ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.Connector {
  ...
  public Port getSource() {
    return (Port) adaptersFactory.createAdapter(ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspect.getSource(adaptee), eResource);
  }
  ...
  public Port getTarget() {
    return (Port) adaptersFactory.createAdapter(ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspect.getTarget(adaptee), eResource);
  }
