...
public class IntermediateConnectorAdapter extends EObjectAdapter<IntermediateConnector> implements ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.IntermediateConnector {
  ...
  public void setSource(final OutgoingPort o) {
    if (o != null)
    	adaptee.setSource(((ur1.diverse.xmontiarc.xdsml.xmontiarc.adapters.xmontiarcmt.xmontiarc.OutgoingPortAdapter) o).getAdaptee());
  ...
  public void setTarget(final IncomingPort o) {
    if (o != null)
    	adaptee.setTarget(((ur1.diverse.xmontiarc.xdsml.xmontiarc.adapters.xmontiarcmt.xmontiarc.IncomingPortAdapter) o).getAdaptee());
    else adaptee.setTarget(null);
  }
  
  @Override
  public String getRepresentation() {
    return ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspect.getRepresentation(adaptee);
  }
  
  @Override
  public String getSourceRepresentation() {
    return ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspect.getSourceRepresentation(adaptee);
  }
  
  @Override
  public String getTargetRepresentation() {
    return ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspect.getTargetRepresentation(adaptee);
  }
  ...
  public EClass eClass() {
    return ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.eINSTANCE.getIntermediateConnector();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INTERMEDIATE_CONNECTOR__PARENT:
    		return getParent();
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INTERMEDIATE_CONNECTOR__SOURCE:
    		return getSource();
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INTERMEDIATE_CONNECTOR__TARGET:
    		return getTarget();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.XmontiarcPackage.INTERMEDIATE_CONNECTOR__TARGET:
    		setTarget(
    		(ur1.diverse.xmontiarc.xdsml.xmontiarcmt.xmontiarc.IncomingPort)
    		 newValue);
    		return;
    }
