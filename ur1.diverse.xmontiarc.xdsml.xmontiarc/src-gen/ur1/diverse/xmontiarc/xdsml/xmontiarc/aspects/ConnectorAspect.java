...
import ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ComponentTypeAspect;
import ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectProperties;
import ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.PortAspect;
...
public class ConnectorAspect {
  public static void update(final Connector _self) {
	final ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectProperties _self_ = ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.ConnectorAspectConnectorAspectContext
			.getSelf(_self);
  ...
  public static Port getSource(final Connector _self) {
	...
	;
	return (ur1.diverse.xmontiarc.xdsml.xmontiarc.xmontiarc.Port) result;
}
  ...
  protected static void _privk3_update(final ConnectorAspectConnectorAspectProperties _self_, final Connector _self) {
    if ((_self instanceof IntermediateConnector)) {
      ...
      EDataType _value = PortAspect.value(_source);
      ...
      if ((_self instanceof IncomingConnector)) {
        ...
        EDataType _value_1 = PortAspect.value(_source_2);
        ...
        if ((_self instanceof OutgoingConnector)) {
          ...
          EDataType _value_2 = PortAspect.value(_source_4);
