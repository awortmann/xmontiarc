...
public class SubcomponentAspect {
  ...
  public static void createDefaultBehavior(final Subcomponent _self) {
	final ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.SubcomponentAspectSubcomponentAspectProperties _self_ = ur1.diverse.xmontiarc.xdsml.xmontiarc.aspects.SubcomponentAspectSubcomponentAspectContext
			.getSelf(_self);
